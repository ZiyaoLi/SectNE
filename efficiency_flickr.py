...
if __name__ == '__main__':
    record = open('flickr-time.log', 'w')
    
    record.write('flickr')

    filename = DATADIR + DATASET + '\\links.txt'
